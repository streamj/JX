...
public class PayEntryVisitor extends SimpleAnnotationValueVisitor7<Void, Void> {
    static final String WE_CHAT_SPEC_ACTIVITY = "WXPayEntryActivity";
    static final String WE_CHAT_SPEC_PACKAGE = ".wxapi";
    static final String FILE_COMMENT = "微信支付入口文件";
    ...
    private void generateJavaCode() {
        final TypeSpec targetActivity = TypeSpec.classBuilder(WE_CHAT_SPEC_ACTIVITY)
